    ...
    <div class="flex justify-center w-full lg:w-[30%]">
      <form @submit.prevent="handleLogin" class="flex flex-col justify-center h-screen">
        ...
        <input type="password" placeholder="Password"
          ...
          required />
        <button type="submit"
          class="bg-blue-500 text-white py-3 rounded-full font-medium relative flex justify-center items-center">
        ...
        <p class="mt-4 flex gap-x-6 text-sm">Don't have an account? <span @click="$router.push('/signup')"
            class="cursor-pointer text-purple-600">Sign Up</span></p>
      </form>
    </div>
  </div>
</template>
